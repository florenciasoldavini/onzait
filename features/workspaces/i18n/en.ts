export default {
  "avatar": {
    ...
    "creationWarning": "The organization was created, but its avatar couldn't be uploaded. You can add it later under General settings.",
    "denied": "Photo access is disabled. Enable it in your device settings, then try again.",
  ...
  "invitationEmail": {
    "deliveryFailed": "The invitation was saved, but the email could not be sent. Wait a minute, then try again.",
    "failed": "Email failed",
    "notSent": "Email not sent",
    "rateLimited": "Please wait before sending another invitation. If you reached the daily limit, try again tomorrow.",
    "resend": "Resend email",
    "resendLabel": "Resend invitation to {{email}}",
    "senderUnavailable": "Invitation emails aren't ready for other recipients yet. Ask the app administrator to finish email setup.",
    "sending": "Email status unconfirmed",
    "sent": "Email sent",
    "statusUnconfirmed": "The email was sent, but its status could not be saved. Check the recipient’s inbox before resending.",
    "unavailable": "We couldn’t send this invitation. Check your connection and try again."
  },
  "invitations": {
  ...
  "members": {
    ...
    "inviteDescription": "They'll receive an invitation to join this organization and access its workspaces.",
    ...
    "remove": "Remove",
    "removeDescription": "{{name}} will immediately lose access to this organization's workspaces and owned data.",
  ...
  "pendingInvitations": {
    ...
    "pending": "Pending",
    "revoke": "Revoke",
    "revokeDescription": "{{email}} will no longer be able to join this organization with the current invitation.",
  ...
  "setup": {
    "additionalDescription": "Create a separate organization with its own workspace, projects, and directory.",
    "additionalSubmit": "Create organization",
    "additionalTitle": "Create a new organization",
    "description": "Create the practice or company that will own your projects, directory, and tasks. You can invite your colleagues afterward.",
    "error": "We could not create your practice or company. Try again.",
    "finish": "Finish setup",
    "invitationSent": "Invitation sent to {{email}}.",
    "inviteDescription": "Invite colleagues to {{organization}} now, or skip this step and add them later from organization settings.",
