alter table public.google_maps_usage_windows
drop constraint if exists google_maps_usage_windows_service_check;

alter table public.google_maps_usage_windows
add constraint google_maps_usage_windows_service_check check (
  service in (
    'places_autocomplete',
    'places_resolve',
    'maps_static_preview'
